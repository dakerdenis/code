...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $form = ['birthDay' => 'date', 'weight' => 'int', 'height' => 'int', 'haveExaminedInLast2Years' => 'bool', 'areHospitalized' => 'bool', 'haveTreatmentOrMedication' => 'bool', 'haveAsthmaAllergiesLungDiseases' => 'bool', 'haveDiseasesOfTheKidneysOrUrinarySystem' => 'bool', 'haveCongenitalAndInheritedDiseases' => 'bool', 'haveHeadachesDizzinessAndMigraines' => 'bool', 'haveDiseasesOfTheEsophagusAndGastrointestinalTract' => 'bool', 'haveBloodPressure' => 'bool', 'haveRheumatism' => 'bool', 'havevaricoseVeinsAndOtherVascularDiseases' => 'bool', 'haveRhythmConductionDisturbancesAndHeartDisease' => 'bool', 'haveMentalIllnessNervousDisorderEpilepsy' => 'bool', 'haveTraumasInjuriesDefects' => 'bool', 'haveProblemsWithLumbarRegionAndSpine' => 'bool', 'haveDiseasesOfTheLiverSpleenPancreas' => 'bool', 'haveBloodDiseases' => 'bool', 'haveDiabetes' => 'bool', 'haveOtherEndocrineDiseases' => 'bool', 'havebenignOrMalignantTumors' => 'bool', 'haveAnyHealthProblemsOtherThanAbove' => 'bool', 'haveInsuredWithAnotherInsuranceCompany' => 'bool',];
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <CalculateMedicalInsurancePrice xmlns="http://tempuri.org/">
    ...
    </CalculateMedicalInsurancePrice>
  </soap:Body>
</soap:Envelope>
DATA;
        ...
        $response = (array) $soap->children('http://schemas.xmlsoap.org/soap/envelope/')->Body->children()
            ->CalculateMedicalInsurancePriceResponse->CalculateMedicalInsurancePriceResult->DocumentElement;
        if (isset($response['ERROR'])) {
            $status = 'fail';
            $message = $response['ERROR']->MESSAGE->__toString();
        } else {
            $status = 'success';
            $price = (float) str_replace(',', '.', str_replace('.', '', $response['INSURANCE_PRICE']->TOTAL_INSURANCE_PRICE->__toString()));
        }

        $data = compact('price', 'status', 'message');
        header('Content-Type: application/json; charset=utf-8');
        echo json_encode($data);
        die();
